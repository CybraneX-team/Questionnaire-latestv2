...
const FormAfter = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const convertedarr = countries.map((e) => {
        return { feature: e, value: 0 };
      });
      const arrToUse = MapValueLogic(
        convertedarr,
        mapData[`Issuer's cost breakdown by geography`]
      );
      const arrToUse2 = MapValueLogic(
        convertedarr,
        mapData[`Issuer's revenue breakdown by geography`]
      );
      const arrToUse3 = MapValueLogic(
        convertedarr,
        mapData[`What is the issuer's controlling jurisdiction?`]
      );
        ...
        data: [
          {
            x: scoreData?.e1_perf,
            y: scoreData?.e1_conf,
            r: Math.floor(scoreData?.e1_weight) * 2,
          },
        ],
        ...
        data: [
          {
            x: scoreData?.e2_perf,
            y: scoreData?.e2_conf,
            r: Math.floor(scoreData?.e2_weight) * 2,
          },
        ],
        backgroundColor: "rgba(40,145,220,0.6)",
      },
      {
        label: "E3",
        data: [
          {
            x: scoreData?.e3_perf,
            y: scoreData?.e3_conf,
            r: Math.floor(scoreData?.e3_weight) * 2,
          },
        ],
        backgroundColor: "rgba(72,180,245,0.6)",
      },
      {
        label: "G1",
        data: [
          {
            x: scoreData?.g1_perf,
            y: scoreData?.g1_conf,
            r: Math.floor(scoreData?.g1_weight) * 2,
          },
        ],
        ...
        data: [
          {
            x: scoreData?.g2_perf,
            y: scoreData?.g2_conf,
            r: Math.floor(scoreData?.g2_weight) * 2,
          },
        ],
        backgroundColor: "rgba(85, 182, 182, 0.6)",
      },
      {
        label: "G3",
        data: [
          {
            x: scoreData?.g3_perf,
            y: scoreData?.g3_conf,
            r: Math.floor(scoreData?.g3_weight) * 2,
          },
        ],
        backgroundColor: "rgba(65, 202, 202, 0.6)",
      },
      {
        label: "S1",
        data: [
          {
            x: scoreData?.s1_perf,
            y: scoreData?.s1_conf,
            r: Math.floor(scoreData?.s1_weight) * 2,
          },
        ],
        ...
        data: [
          {
            x: scoreData?.s2_perf,
            y: scoreData?.s2_conf,
            r: Math.floor(scoreData?.s2_weight) * 2,
          },
        ],
        backgroundColor: "rgba(245, 149, 54, 0.6)",
      },
      {
        label: "S3",
        data: [
          {
            x: scoreData?.s3_perf,
            y: scoreData?.s3_conf,
            r: Math.floor(scoreData?.s3_weight) * 2,
          },
        ],
        backgroundColor: "rgba(265, 169, 74, 0.6)",
      },
      {
        label: "overall",
    ...
    <div>
      ...
      <div className="rSummary">
        ...
        <div className="contextDiv">
          <textarea
            onChange={handleChange}
            name="Research framework and methodologies"
            placeholder="Research framework and methodologies"
            className="textAreaClass new"
            rows="4"
            cols="124"
          ></textarea>
      ...
      <div className="rSummary">
        ...
        <div className="analysisDiv" id="AnalysisContinued">
          ...
          <textarea
            ...
            rows={5}
            cols={55}
            placeholder="Confidence Analysis"
          />
          <br />
          <textarea
            onChange={handleChange}
